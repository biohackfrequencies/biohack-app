...
export const appContentData: AppContentData = {
  "categories": {
    ...
    "focus": {
      ...
      "description": "Advanced audio protocols inspired by Hemi-Sync, designed to achieve specific states of consciousness for deep meditation and exploration.",
      "colors": { "primary": "#e9d5ff", "secondary": "#c4b5fd", "accent": "#d8b4fe" }
    },
    "brainwaves": {
    ...
    "isochronic": {
      "title": "Isochronic Pulses",
      "description": "Rhythmic pulses of sound that powerfully entrain the brain without headphones. Effective for focus, energy, and achieving deep mental states.",
  ...
  "guided_sessions": [
    ...
    {
      "id": "cellular-longevity-protocol", "title": "Cellular Longevity Protocol", "categoryId": "beauty", "description": "A 22-minute session to support graceful aging by targeting NAD+ levels and promoting deep cellular restoration during Delta wave states.", "steps": [ { "title": "NAD+ Boost", "description": "A specialized frequency protocol designed to support the body's natural production of NAD+, a key molecule in longevity.", "duration": 720, "frequencyId": "nad-plus-booster" }, { "title": "Deep Restoration", "description": "Enter a deep Delta wave state, the brain's primary state for physical repair and cellular cleansing (autophagy).", "duration": 600, "frequencyId": "delta" } ], "colors": { "primary": "#a5f3fc", "secondary": "#67e8f9", "accent": "#22d3ee" }, "premium": true
    },
    {
      "id": "adhd-focus-protocol", "title": "ADHD Focus Protocol", "categoryId": "guided", "description": "A 25-minute protocol that starts with calming Theta waves to quiet a busy mind and then transitions to Beta waves to support sustained, focused attention.", "steps": [ { "title": "Calm the Mind", "description": "Begin with Theta waves to reduce mental chatter and create a state of relaxed awareness.", "duration": 600, "frequencyId": "theta" }, { "title": "Engage Focus", "description": "Transition to a steady Beta wave frequency to promote alertness and concentration.", "duration": 900, "frequencyId": "beta" } ], "colors": { "primary": "#e0e7ff", "secondary": "#c7d2fe", "accent": "#818cf8" }, "premium": true
    },
    {
  ...
  "initial_frequencies": [
    ...
    },
    {
      ...
      "baseFrequency": 136.1,
      "binauralFrequency": 10,
      "description": "A 10 Hz isochronic pulse for deep, clear-headed relaxation and stress reduction. Perfect for entering a meditative state quickly.",
      "category": BenefitCategory.RELAXATION,
    ...
    {
      "id": "isochronic-theta",
      "name": "Isochronic Theta",
      "range": "6 Hz Pulse",
      "baseFrequency": 136.1,
      "binauralFrequency": 6,
      "description": "A 6 Hz isochronic pulse to access deep creativity, intuition, and enhanced memory consolidation. Ideal for creative visualization.",
      "category": BenefitCategory.COGNITIVE,
      "categoryId": "isochronic",
      "defaultMode": "ISOCHRONIC",
      "availableModes": ["BINAURAL", "ISOCHRONIC"],
    ...
    {
      "id": "isochronic-beta",
      "name": "Isochronic Beta",
      "range": "20 Hz Pulse",
      "baseFrequency": 136.1,
      "binauralFrequency": 20,
      "description": "A 20 Hz isochronic pulse for sharp focus and mental energy. Use this for intense work sessions or to combat mental fatigue.",
      "category": BenefitCategory.COGNITIVE,
      "categoryId": "isochronic",
      "defaultMode": "ISOCHRONIC",
      "availableModes": ["BINAURAL", "ISOCHRONIC"],
    ...
    {
      "id": "isochronic-gamma",
      "name": "Isochronic Gamma",
      "range": "40 Hz Pulse",
      "baseFrequency": 136.1,
      "binauralFrequency": 40,
      "description": "A 40 Hz isochronic pulse for peak cognitive performance, problem-solving, and accessing states of high creativity.",
      "category": BenefitCategory.COGNITIVE,
      "categoryId": "isochronic",
      "defaultMode": "ISOCHRONIC",
      "availableModes": ["BINAURAL", "ISOCHRONIC"],
    ...
    {
      "id": "isochronic-delta-sleep",
      "name": "Isochronic Delta Sleep",
      "range": "2.5 Hz Pulse",
      "baseFrequency": 136.1,
      "binauralFrequency": 2.5,
      "description": "A 2.5 Hz isochronic pulse to guide your brain into deep, restorative delta sleep. Ideal for overcoming insomnia.",
      "category": BenefitCategory.RELAXATION,
      "categoryId": "isochronic",
      "defaultMode": "ISOCHRONIC",
      "availableModes": ["BINAURAL", "ISOCHRONIC"],
