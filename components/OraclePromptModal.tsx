    ...
    return (
        ...
        >
            <div className="relative text-center bg-white/90 dark:bg-slate-800/90 rounded-2xl shadow-xl w-full max-w-sm p-8">
                <button onClick={onClose} className="absolute top-3 right-3 p-1 text-slate-400 dark:text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors" aria-label="Close reflection prompt">
                    <XMarkIcon className="w-6 h-6" />
                </button>
                <OracleIcon className="w-16 h-16 text-brand-gold mx-auto mb-4" />
                <h3 id="oracle-modal-title" className="text-xl font-display font-bold text-slate-800 dark:text-dark-text-primary">Reflection</h3>
